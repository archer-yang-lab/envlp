...
%  the scaled predictor envelope model.
...
% identity matrix $I_p$.
% * TestInput.R: The matrix multiplied to $$\beta$ on the right.  It is an r
...
% L\beta R\neq A$.  The $$\beta$ is estimated by the scaled predictor envelope model.  If
...
function TestOutput = testcoefficient_sxenv(ModelOutput, TestInput)
