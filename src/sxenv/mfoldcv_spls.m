%% mfoldcv_spls
% Select the dimension in the scaled SIMPLS algorithm using 
...
% in the scaled SIMPLS algorithm, based on prediction performance.  For each u, the
...
function SelectOutput = mfoldcv_spls(X, Y, m, Opts)
