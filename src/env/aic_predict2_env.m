%% aic_predict2_env
% Select the dimension of the constructed partial envelope subspace using Akaike information
% criterion.
%% Syntax
...
function u = aic_predict2_env(X, Y, Xnew, Opts)
