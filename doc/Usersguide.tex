...
\hline 
\hline 
\multirow{3}{*}{\parbox[t]{5cm}{\footnotesize Envelope Model for Estimating Multivariate Means}} & {\footnotesize AIC} & {\footnotesize Estimation and Prediction} & \multirow{3}{*}{{\footnotesize \ref{sec_envmean}}}\tabularnewline
\cline{2-3} 
 & {\footnotesize BIC} & {\footnotesize Bootstrap for Estimating Standard Errors} & \tabularnewline
\cline{2-3} 
 & {\footnotesize LRT} & {\footnotesize Hypothesis Test on Coefficients} & \tabularnewline
