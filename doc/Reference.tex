...
\end{par} \vspace{1em}
\begin{par}
For model type for method 'env', 'envseq', 'henv', 'ienv', ' senv', 'xenv' and 'xenvpls'. X is an n by p matrix, p is the number of predictors.
\end{par} \vspace{1em}
\begin{par}
...
\end{par} \vspace{1em}
\begin{par}
\textbf{modelType}: A string characters indicting the model, choices can be 'env', 'envseq', 'henv', 'ienv', 'penv', 'senv', 'xenv' and 'xenvpls'.
\end{par} \vspace{1em}
\begin{par}
...
\begin{par}
bootse: For 'env', 'envseq', 'henv', 'ienv', and 'senv', an r by p matrix containing the standard errors for elements in $\beta$ computed by bootstrap.  For 'penv', an r by p1 matrix containing the standard errors for $\beta_1$ computed by bootstrap.  For 'xenv' and 'xenvpls', a p by r matrix containing the standard errors for elements in $\beta$ computed by bootstrap.
\end{par} \vspace{1em}
...
\begin{verbatim}       modelType = 'envseq';
...
\end{par} \vspace{1em}
\begin{par}
\textbf{modelType}: A string characters indicting the model, choices can be 'envseq' or 'xenvpls'.
\end{par} \vspace{1em}
\begin{par}
